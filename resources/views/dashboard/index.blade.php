...
<head>
    ...
    <title>Hariawan Maulana - UTS Pemograman Web Lanjut</title>
    <!-- Favicon-->
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top">Hariawan maulana</a>
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0">Hariawan Maulana</h1>
            <!-- Icon Divider-->
    ...
    <!-- Blog Section-->
    <section class="page-section bg-primary text-white mb-0 portfolio" id="blog">
        <div class="container">
    ...
    <section class="page-section" id="about">
        <div class="container">
            ...
            <div class="text-center mt-4">
                <a class="btn btn-success btn-xl btn-outline" href="https://startbootstrap.com/theme/freelancer/">
